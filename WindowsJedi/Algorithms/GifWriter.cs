...
namespace WindowsJedi.Algorithms
{
    ...
    public class GifWriter : IDisposable
    {
        ...
        /// </summary>
        public GifWriter(string fileName, Size size)
        {
        ...
        public void WriteImageFrame(Bitmap frame)
        {
            ...
            frame.Save(_buffer, ImageFormat.Gif); // This makes a mes of the dithering. To be improved... ( http://codebetter.com/brendantompkins/2007/06/14/gif-image-color-quantizer-now-with-safe-goodness/ )
